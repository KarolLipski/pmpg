...
describe SellPointsController do
  ...
  # SellPoint. As you add validations to SellPoint, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # SellPointsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sell_point" do
        sell_point = SellPoint.create! valid_attributes
        # Assuming there are no other sell_points in the database, this
        # specifies that the SellPoint created on the previous line
